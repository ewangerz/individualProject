...
<body>
  ...
  <section id="title-section">
        ...
        <h1>People!</h1>
        <h2>Photos I've taken based on different events!</h2>
...
if __name__ == "__main__":
    ...
    section_folders = {
        "Atlas Digital": "images/people/atlas-digital",
        "Alpha Theta Delta": "images/people/atd",
        "Michigan Math and Science Scholars": "images/people/mmss",
    ...
    with open("people.html", "w", encoding="utf-8") as file:
        file.write(html_output)

    print("HTML file generated successfully: people.html")
